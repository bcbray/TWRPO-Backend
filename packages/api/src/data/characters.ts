...
export const wrpCharacters: WrpCharacters = {
    ...
    AgrippaMaxentius: [
        ...
        { id: 2600, name: 'Rafael "Rafa" Fuentes' },
    ],
    aintitadam: [
    ...
    alexaryta: [
        { id: 2595, name: 'Eilidh Buchan' },
    ],
    alittlesoupy: [
        { id: 2627, name: 'Lily DuBois' },
    ],
    alleycatpack: [
    ...
    AmiAymi: [
        { id: 2406, name: 'Bailey Hanson-Holt', factions: ['10 Tonne Gang'] },
    ],
    Amora_xox: [
    ...
    BarlowOfficial: [
        ...
        { id: 2460, name: 'David Caine', deceased: true },
        { id: 2461, name: '[Deputy] Sebastian Augustine', nicknames: ['Seb'], factions: ['Law'], deceased: true },
        { id: 2606, name: '[Ranger] Emmett Cassidy', displayName: 2, factions: ['Rangers'] },
    ],
    BarryBogan: [
    ...
    bashley168: [
        ...
        { id: 2472, name: '[Recruit] Piper Owens', factions: ['Rangers'] },
        { id: 2473, name: 'Veyla W' },
    ],
    BASHZOR: [
    ...
    bearfromopenseason: [
        ...
        { id: 2474, name: 'Carmine Prince' },
        { id: 2475, name: '? "Ray Ray" ?' },
    ],
    BearofFlame: [
    ...
    BradWOTO: [
        ...
        { id: 2478, name: '[Deputy] Lucien Lorde', factions: ['Law'] },
        { id: 2479, name: 'Levi ?' },
    ],
    BrambleLeaf: [
    ...
    Brizzo24: [
        ...
        { id: 2480, name: 'Eli Johnson' }, // Law hopeful
    ],
    broxh_: [
    ...
    captain_dimples: [
        ...
        { id: 2481, name: 'Casidy Jones', nicknames: ['Doe', 'Lily'] },
        { id: 2482, name: 'Analeigh Atkinson' },
        { id: 2483, name: 'Bonnie Bellamy' },
    ],
    CaptainMeef: [
    ...
    ChaoticCreative: [
        ...
        { id: 2592, name: 'Roland Pace' },
        { id: 2619, name: 'Benedict Grey' },
    ],
    charlieblossom: [
    ...
    Coolidge: [
        ...
        { id: 2485, name: 'Dan Cook', factions: ['Perma Trail'], deceased: true },
    ],
    CoolRanchOfficial: [
    ...
    CyberGoosey: [
        ...
        { id: 2489, name: '[Medic] Konstantin Zolotov', factions: ['Medical'] },
    ],
    CyboargTV: [
    ...
    DarthBoba04: [
        ...
        { id: 2490, name: '[Ranger] James Quincy', factions: ['Rangers'] },
    ],
    Darthbobo77: [
    ...
    DavidEarl: [
        ...
        { id: 2491, name: 'Whittaker Gribbins' },
    ],
    DDPeter: [
    ...
    DearJhnnn: [
        ...
        { id: 2492, name: 'Brutus Caldwell' },
        { id: 2493, name: 'Zaru Perri' },
    ],
    deciBel42: [
        { id: 1141, name: 'Kit Bishop', telegram: 'OG840' },
        { id: 1340, name: 'Billy Burgs', telegram: 'TM375' },
        { id: 2494, name: 'Ezekiel Oatbottom' },
        { id: 2495, name: 'Terrance Witt' },
        { id: 2496, name: 'Franklin Marlowe' },
    ],
    defanxious: [
    ...
    Demorga_: [
        ...
        { id: 2456, name: 'Wyatt Shepherd', deceased: true },
        { id: 2498, name: 'Cletus Letourneau' },
    ],
    DeneeSays: [
        { id: 205, name: 'Brooke "Babs" Burns', factions: ['DiCenzo Famiglia'], telegram: 'AT704' },
        { id: 2499, name: 'Sadie-Jean "Sadie" ?' },
    ],
    Deputy_Games: [
    ...
    DiceTTRPG: [
        { id: 2622, name: 'Michael Lynch' },
    ],
    DidaxEric: [
        { id: 2344, name: 'Mitchell Lewis' },
        { id: 2500, name: 'William Davenport' },
    ],
    DinoNotDeeno: [
        { id: 1970, name: 'Sam Colt' },
        { id: 2162, name: 'Blanche Martin' },
        { id: 2501, name: 'Sam Mercer' },
    ],
    Dimitri: [
    ...
    DisbeArex: [
        ...
        { id: 2502, name: 'Priscilla Baker', factions: ['Perma Trail'], deceased: true },
    ],
    DJADIP: [
    ...
    DungeonRP: [
        ...
        { id: 2507, name: 'Reginald Bacious Crust' },
        { id: 2508, name: 'Desmond Hughes' },
        { id: 2509, name: 'Maurice Lumbeaux' },
        { id: 2510, name: 'Goldie ?' },
    ],
    Dunrunnin: [
        { id: 252, name: 'Clay ?' },
        { id: 2511, name: 'Tybolt Ferryman' },
    ],
    Duntless_: [
    ...
    DustMonkey: [
        ...
        { id: 2512, name: 'William Rackham' },
        { id: 2513, name: 'Artyom Volkov' },
    ],
    DutchKroket: [
    ...
    embernocte: [
        ...
        { id: 2515, name: 'Emerald Christmas' },
        { id: 2620, name: 'Iris Lockes' },
    ],
    EMBVRMusic: [
    ...
    EmeraldElephant_: [
        ...
        { id: 2516, name: '[Deputy] ? Ryder', factions: ['Law'] },
        { id: 2517, name: 'Percy ?' },
    ],
    emily_xb: [
    ...
    EricaPlz: [
        ...
        { id: 1240, name: '[Deputy] Olya Ivanavia', displayName: 1, factions: ['Law'], formerFactions: ['Rangers'], telegram: 'UB094', deceased: true }, // Former Ranger
    ...
    fayebles: [
        ...
        { id: 2521, name: 'Connie Jenkins' },
        { id: 2522, name: 'Stephanie Winthrop' },
    ],
    feardeer: [
    ...
    fenrirsgaming: [
        ...
        { id: 2375, name: '[Ranger] Shane Cormac', factions: ['Rangers'] },
        { id: 2523, name: 'Franciso "Cisco" Rivera' },
    ],
    FhaeLin: [
        ...
        { id: 2524, name: 'Jean Marsh' },
        { id: 2525, name: 'Iris Bramble', factions: ['Perma Trail'] },
    ],
    FirecrackThat: [
    ...
    flaymayweather: [
        ...
        { id: 2529, name: '[Cadet] Wardell Bullock', nicknames: ['Dell'], factions: ['Law'] },
    ],
    Flickerclad: [
    ...
    FroisLost: [
        ...
        { id: 1884, name: '[Sr. Officer] Lucia Nordskov', nicknames: ['Inya Nordskov', 'Lucia Wellmore', 'Inya Wellmore', 'Charity'], factions: ['Conductors'], formerFactions: ['Medical'] }, // Former Medic
    ],
    FrontlineBanana: [
    ...
    GobbleHawk: [
        ...
        { id: 2534, name: 'Eustace Fulton' },
        { id: 2535, name: 'Peter Swift' },
    ],
    Goochy: [
    ...
    GothBro: [
        ...
        { id: 2614, name: '[Deputy] Blake Evans', factions: ['Law'] },
    ],
    gothybee: [
        { id: 882, name: 'Alawa "Ali" Meota' },
    ],
    GrammTheGibbon: [
        { id: 363, name: 'Jimothy Little', nicknames: ['Little Jimothy', 'LJ', 'Kid'], displayName: 3, factions: ['Little Gang'], leader: true, formerFactions: ['Dead End Gang'], telegram: 'SI011', deceased: true },
    ...
    GreymoorGaming: [
        ...
        { id: 1948, name: '[Sr. Deputy] August Gray', factions: ['Law'] },
    ],
    GrumpyChunkyMonkey: [
    ...
    Hawkward_Trent: [
        { id: 2624, name: 'James Arthur McCoy' },
    ],
    Haxi_: [
        ...
        { id: 2538, name: 'Frank Donnelly', factions: ['One Life'] },
    ],
    Heikima: [
    ...
    Hoop: [
        ...
        { id: 2337, name: 'Ezekiel "Zeek" McCoy' },
    ],
    hopdowg: [
    ...
    im_unruly: [
        ...
        { id: 2542, name: 'Vincent "Vinny" Valentino' },
    ],
    inkyblackdreams: [
    ...
    iruASH: [
        ...
        { id: 2546, name: '[Deputy] Graham Anderson', factions: ['Law'] },
    ],
    ItalianNinjaa: [
    ...
    ItsMoppet: [
        ...
        { id: 2454, name: 'Billy "Big Billy" Blue', deceased: true },
        { id: 2548, name: '[Trainee] Duncan McIntyre', factions: ['Medical'] },
    ],
    itsSANDR: [
    ...
    ItzDinny: [
        { id: 2618, name: 'Cillian Hennessey' },
    ],
    IvorySnowPlays: [
    ...
    Iwhuttt: [
        ...
        { id: 2549, name: 'Vincent Bane' },
        { id: 2550, name: 'Michael Lloyd' },
        { id: 2551, name: 'Misha Rozanov' },
    ],
    izza_bug: [
    ...
    jaelymawi: [
        ...
        { id: 2554, name: 'Willie Whisper' },
        { id: 2555, name: 'Douglas Duffy' },
    ],
    JakeVdatsme: [
        ...
        { id: 2556, name: 'Sid Jones' },
        { id: 2557, name: 'Dusty Rhodes' },
    ],
    jakeyp0o: [
    ...
    jobyonekanobi: [
        ...
        { id: 2559, name: 'Leo Stafford' },
        { id: 2560, name: '[Cadet] Flynn Blondie', factions: ['Law'] },
    ],
    Jogiiee: [
    ...
    JoeGarbage_: [
        ...
        { id: 2561, name: 'Timothy Prostaite', factions: ['One Life'] },
    ],
    joemorf: [
    ...
    KinkyHobo: [
        ...
        { id: 2565, name: 'Wyatt Bones', factions: ['One Life'] },
    ],
    KittyLeigh: [
        { id: 476, name: 'Delilah' },
    ],
    Kirah_Hellrose: [
        ...
        { id: 2566, name: 'Abigail Fenix' },
        { id: 2567, name: 'Anthony "Kelly" Slater' },
        { id: 2568, name: 'Hayden Prince' },
    ],
    Kirikuwaa: [
    ...
    lizzyyyy: [
        ...
        { id: 2572, name: 'Evelyn Jackson-Brown' },
    ],
    ll_Marziano_ll: [
    ...
    Mackaelroni: [
        ...
        { id: 2576, name: 'Bo Bassett' },
        { id: 2577, name: 'Wyatt Tanner' },
    ],
    Mackie_nx: [
    ...
    MadHare_23: [
        ...
        { id: 2578, name: 'Ames Clafford' },
        { id: 2579, name: 'Rusty Dann' },
        { id: 2580, name: 'Avery Stone' },
        { id: 2581, name: 'Tim Tom' },
    ],
    Madmoiselle: [
    ...
    MEKABEAR: [
        ...
        { id: 2583, name: 'Madge Waterson', factions: ['Perma Trail'], deceased: true },
    ],
    MelanieMint: [
    ...
    MetamorfLive: [
        ...
        { id: 1987, name: 'Silas Shepherd', deceased: true },
    ...
    MforMoody: [
        { id: 2471, name: 'Robert Norton Moody' },
        { id: 2601, name: 'Abdul al-Qadir', nicknames: ['The Egyptian'] },
    ],
    Mhaple_: [
    ...
    Moonvirse: [
        { id: 2457, name: 'Hunter LeBow', deceased: true },
    ],
    mr_baker99: [
        { id: 1986, name: 'Charlie Baker', assume: 'assumeOther' },
    ],
    Mr_Spalk: [
        { id: 2617, name: 'Ahanu Upstream' },
    ],
    MrArkay: [
        ...
        { id: 2584, name: 'Daryle Merlott' },
        { id: 2585, name: 'Charlie Neil' },
        { id: 2586, name: 'Reuse Hathlock' },
    ],
    MrBrandoTV: [
    ...
    mrwolfff98: [
        ...
        { id: 2459, name: '[Deputy] Colt Garrett', factions: ['Law'], deceased: true },
    ],
    MsVenture: [
    ...
    OwenSeven: [
        ...
        { id: 2605, name: 'Walter Wheeler', nicknames: ['Walt'] },
    ],
    p3t3_ttv: [
    ...
    sneakyShadower: [
        ...
        { id: 2455, name: 'Annabeth "Annie" Shepherd', deceased: true },
        { id: 2463, name: 'Gabrielle "Miss Teal" Hemming' },
        { id: 2464, name: '[Medic] Sonea Payton', factions: ['Medical'] },
    ],
    SocialTortoise: [
    ...
    TacticalGH0STT: [
        { id: 808, name: '[Ranger] Beaux Carter', factions: ['Rangers'], telegram: 'EU031', assume: 'assumeOther' },
    ...
    TankGirl: [
        ...
        { id: 1165, name: '[Warden] Hattie Booker', factions: ['Sisika Guard'], displayName: 2, deceased: true },
    ...
    TheGeneralSmokey: [
        { id: 861, name: 'Edwin Braithwaite', nicknames: ['Eddie', 'Eddie Braithwaite', 'Prisoner 462503', '462503'], factions: ['Dead End Gang'], formerFactions: ['Kettleman Gang'], telegram: 'WZ827', deceased: true },
    ...
    Tonixion: [
        ...
        { id: 2613, name: 'Quinton Huxley' },
        { id: 2615, name: 'Damon Reeves' },
    ],
    toodlehausn: [
    ...
    VERTiiGOGAMING: [
        ...
        { id: 920, name: 'Richard "The Wallaby Kid" Eastwick', nicknames: ['Joey Johns'], factions: ['Dead End Gang'], telegram: 'NS591', deceased: true },
