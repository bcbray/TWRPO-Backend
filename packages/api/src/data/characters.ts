...
export const wrpCharacters: WrpCharacters = {
    ...
    GmanRBI: [
        { id: 351, name: '[Deputy] Max Brady', factions: ['Law'], telegram: 'GH469' }, // Former Sam's Club
    ...
    JustSam42: [
        { id: 462, name: '[Game Warden] Nathan Thompson', factions: ['Rangers'], telegram: 'EY079' },
    ],
    JxdiTV: [
    ...
    mrwolfff98: [
        ...
        { id: 1493, name: '[Recruit] Ellis Wade', factions: ['Rangers'], telegram: 'SU750' },
    ],
    MsVenture: [
    ...
    TheRandomChick: [
        ...
        { id: 877, name: '[Sr. Reporter] Poppet Deveaux', nicknames: ['Caroline'], factions: ['News'] },
    ...
    Tmparro01: [
        { id: 1580, name: '[Cadet] Rubin Wiley', factions: ['Law'] },
    ],
    TnFD: [
