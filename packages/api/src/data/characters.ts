...
export const wrpCharacters: WrpCharacters = {
    ...
    BluebonnetRP: [
        { id: 1475, name: '[Cadet] Lorenzo Roussan', factions: ['Law'] },
    ],
    BooksBlanketsandTea: [
    ...
    calliecakes: [
        { id: 132, name: 'Amelie Coiner', nicknames: ['Amelie Ashton'] },
    ],
    CallisTV: [
    ...
    luka_aus: [
        { id: 533, name: 'Lukeas Winsmore', factions: ['The Baastards'], telegram: 'YU594' }, // Former Boons Boys
    ...
    stardaze: [
        ...
        { id: 1462, name: 'Rook Pierce', factions: ['Red Water'] },
    ],
    start_vx: [
