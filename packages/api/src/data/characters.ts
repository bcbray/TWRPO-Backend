...
export const wrpCharacters: WrpCharacters = {
    ...
    '893SHIRO': [
        ...
        { id: 1249, name: 'Giuseppe "il Pepe" DeMarco' },
    ],
    AaronOnAir: [
    ...
    Cheever7: [
        ...
        { id: 1241, name: '[Cadet] Maya Brooks', factions: ['Law'] },
    ],
    ChickPenguin: [
    ...
    GooseyOfficial: [
        ...
        { id: 360, name: 'Speedy McGillagully', factions: ['Dead End Kids'] },
    ...
    Heikima: [
        ...
        { id: 1173, name: 'Koxinga Zheng', nicknames: ['Mr. Ko', 'Mr Ko'], displayName: 3 },
    ...
    kono5alive: [
        { id: 1177, name: '? "Big L" ?', factions: ['Sisika Guard'] },
    ...
    uncledirtbag: [
        ...
        { id: 1250, name: '[Cadet] Robert Herrera', factions: ['Law'] },
    ],
    unstoppableLARN: [
