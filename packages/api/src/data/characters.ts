...
export const wrpCharacters: WrpCharacters = {
    ...
    CoolRanchOfficial: [
        ...
        { id: 1777, name: '[Cadet] Sadie Parker', factions: ['Law'], telegram: 'ED325' },
    ],
    ...
    endangeredfinley: [
        ...
        { id: 277, name: '[Doctor] Bonnie Gray', factions: ['Medical'], telegram: 'SE096' },
    ...
    Haxi_: [
        ...
        { id: 1799, name: 'Bradley Arthur', factions: ['Bluestone'] },
    ],
    Heikima: [
    ...
    RossThehSauce: [
        { id: 682, name: 'Murrietta Walton', nicknames: ['Forest', 'Forest Fish', 'Murry'], displayName: 5, factions: ['Independent', 'Guppy Gang'], telegram: 'IF559' }, // Former Baastard
