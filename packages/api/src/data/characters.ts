...
export const wrpCharacters: WrpCharacters = {
    ...
    DutchKroket: [
        { id: 1875, name: '? Bjornson', nicknames: ['North', 'White Axe'], displayName: 3 },
    ...
    luka_aus: [
        ...
        { id: 1363, name: '[Cadet] Cain Maloo', factions: ['Law'], telegram: 'QA880' },
    ...
    squeakinghiccups: [
        ...
        { id: 1724, name: 'Penny Wallace', telegram: 'VN087' },
