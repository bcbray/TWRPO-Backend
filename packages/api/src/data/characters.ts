...
export const wrpCharacters: WrpCharacters = {
    ...
    Iceshredder_: [
        { id: 1630, name: 'Rockford McGillicuddy', nicknames: ['Rock'] },
    ],
    ICoolioM: [
        { id: 404, name: 'Arie ?' },
    ],
    ...
    Jonthebroski: [
        ...
        { id: 1711, name: 'Rudolph Gold', telegram: 'ZT342' },
    ],
    jsaabb: [
    ...
    muhzzy: [
        ...
        { id: 1697, name: 'Enoch "Big Chomp" Holt', nicknames: ['Chomp'], telegram: 'JN479' },
    ],
    Myre: [
    ...
    sulley_cs: [
        ...
        { id: 1169, name: '[Cadet] Black Sky', displayName: 0, factions: ['Law'], telegram: 'OT409' },
