...
export const wrpCharacters: WrpCharacters = {
    ...
    '2hands2thumbs': [
        ...
        { id: 1166, name: '[Cadet] Finnagan Huxley', factions: ['Law'], telegram: 'FH202' },
    ],
    '52Chains': [
    ...
    EricaPlz: [
        ...
        { id: 1240, name: '[Ranger] Olya Ivanavia', factions: ['Rangers'] },
    ],
    eternalsong: [
    ...
    IzzaBugg: [
        ...
        { id: 1375, name: '[Cadet] Elena Henley', factions: ['Law'] },
    ],
    J0J0: [
